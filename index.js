...
let key = "AIzaSyCuQE_L3Ac84gDynBNShds26HKN9ie6ogo"
...
{
    try {
        let res = await fetch(`https://www.googleapis.com/youtube/v3/search?key=${key}&q=ISRO&type=video&part=snippet&maxResults=20`)
